...
$code=$_GET['code'];
$sql='select * from lab where code like :code';
$pdo=get_db_connect();
      ...
      <div id="all">
        ...
        <div id="wrap">
          ...
          <div id="pnkz">
              <ul>
                ...
                <li><a href="/events/honbu/lab.html">研究室企画</a></li>
                <li><a href="/events/honbu/lab.php?code=<?php echo($code);?>"><?php echo($event_name);?></a></li>
              </ul>
            </div>
        ...
        <footer-menu></footer-menu>
          ...
          <script>
            ...
            var author1="<?php echo($section_name); ?>";
            var author2="<?php echo($field);?>";
